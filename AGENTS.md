...
- 2026-07-15: When asked to "also show" a new display format (e.g. CIP-0129 gov action ID), do not assume it replaces the existing fields — confirm whether it supplements or substitutes them. Default to supplementing unless told otherwise.
